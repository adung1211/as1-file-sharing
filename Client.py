...
class Client:
    def __init__(self, server_address):
        ...
        self.p2p_socket.bind((self.client_socket.getsockname()[
                             0], self.client_socket.getsockname()[1]))
    ...
    def p2p_connection(self):
        while True:
            ...
            threading.Thread(target=self.p2p_handle, args=(
                send_socket, send_addr)).start()
